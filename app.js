...
function productCard(p){
  ...
  return `<article class="card product-card product-catalog-card">
    ...
    <div class="product-info">
      ...
      <div class="product-actions">
        <button class="btn btn-cart-wide" onclick="addToCart('${p.id}')">Add to cart</button>
        <a class="btn btn-outline btn-view-mini" href="product.html?id=${p.id}">View</a>
      </div>
    </div>
  </article>`;
}
